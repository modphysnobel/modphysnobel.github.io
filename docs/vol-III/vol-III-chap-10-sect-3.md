...
!!! info "The LIGO project as a learning community."
    ...
    -
     ...
     <tr>
    <td>
    2017: Observation of one more black hole merger event (GW170814); for the first time this was also observed in the Virgo detector near Pisa in Italy. Virgo is a collaboration of France, Italy, Netherlands, Poland and Hungary. … Adding Virgo, in this detection, not only gives independent confirmation of the LIGO black hole merger detections but improves markedly the ability to triangulate. This is a precursor to also adding KAGRA in Japan and LIGO-India detectors to the network.
    </td>
    <td>
    X
    </td>
    ...
    -
     ...
     <tr>
    <td>
    2017: First joint detection of gravitational and electromagnetic waves from the same astrophysical source (event GW170817). All the data agrees with the hypothesis that the source is the merger of two neutron stars in the host galaxy NGC4993 in the constellation of Hydra.
    </td>
    <td>
    X
    </td>
