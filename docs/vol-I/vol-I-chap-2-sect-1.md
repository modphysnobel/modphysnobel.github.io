...
The region of **Preparation** contains a triode with a heated filament for emitting electrons, a negative cathode ($C$), a collecting anode ($A$) and in between them a polarized grid ($G$) (Figure 2.3a).
...
<table width="100%">
	...
	<th width="50%">
	<figure markdown>
	<img width="200" src="https://github.com/modphysnobel/modphysnobel.github.io/blob/main/docs/vol-I/figs/Vol-I-chap-2-sect-1-Fig10b.PNG?raw=true"> 
	</figure>
	</th>
	<th width="50%">
	<figure markdown>
