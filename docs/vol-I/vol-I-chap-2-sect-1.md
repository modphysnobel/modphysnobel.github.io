...
The region of **Transformation** is the space surrounding _F_ and _G_ filled with atoms of Mercury vapor (<img width="25" src="https://github.com/modphysnobel/modphysnobel.github.io/blob/main/docs/vol-I/figs/electron.PNG?raw=true">). An external variable potential (_V_) accelerates the electrons from _F_ towards _G_ provoking multiple collisions with electrons belonging to Mercury atoms. Besides a small retarding potential $V_R$ was applied between _G_ and _A_.
