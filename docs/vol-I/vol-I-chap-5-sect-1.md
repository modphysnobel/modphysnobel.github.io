...
There is a quantitative connection between the attosecond timescale (1 as = 10<sup>-18</sup> s) and the age of the universe which is estimated to be <p>13.8 x 10<sup>9</sup> years = 4.35 x 10<sup>18</sup> s</p>. This numerical equivalence does not imply that measuring in attoseconds directly influences descriptions of cosmic dynamics; it is a conceptual circumstance that places ultrafast physics in the whole context of time evolution.
