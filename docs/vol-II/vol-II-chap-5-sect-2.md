...
<img src="./figs/chap-5-sect-2-fig1.png" width=300 align=center>
Source: https://upload.wikimedia.org/wikipedia/commons/5/54/Train_station%2C_underpass%2C_stairs_with_bicycle_ramp%2C_2019_Csorna.jpg
...
<img src="./figs/chap-5-sect-2-fig2.JPG" width=480 align=center>
Source: https://upload.wikimedia.org/wikipedia/commons/0/0b/PSM_V03_D012_Vibration_phases.jpg
...
In the same year of 1893 Wien proposed a function to describe the spectral energy density (u), or energy per unit of volume per unit of frequency of radiation within the blackbody cavity: $u(f,T) = α (f)3exp(-βf/T)$, where $f$ is the frequency, $T$ is the temperature, and $α$ and $β$ are constants. This result is called Wien's power law. In 1911 he received the Nobel Prize in Physics “for his discoveries regarding the laws governing the radiation of heat”. His Nobel Lecture *On the Laws of Thermal Radiation*, is a very complete description of his researches and includes comments about the conceptual difficulties and achievements of the time.
...
5.	**Boltzmann calculation:** The set of oscillators representing parts of the cavity in thermal equilibrium with the electromagnetic radiation contained in the cavity. To account for the energy of these oscillators, the statistical method followed by Boltzmann is applied. He calculated the behavior of an ideal gas composed of many molecules moving rapidly and disorderly inside a container, frequently colliding with each other and with the walls of the container.
...
STAGE 4: *The solution plan presented schematically in the previous stage is put into practice by applying the necessary mathematical procedures and techniques (see Planck's Nobel Prize Lecture in section 5.3)*.

STAGE 5: *Final stage dedicated to metacognitive reflections with two purposes: to rethink the four previous stages and to analyze possible modifications or extensions of the problem statement. This review requires a critical analysis of the complete solution comprising its implementation and its evaluation.*

It is now convenient to consider the changes introduced by Planck's solution taking into account what according to Kuhn (1962) are the characteristic changes of a scientific revolution:
...
[**5.3.  Components of the explanation of scientific theories**](https://github.com/modphysnobel/pbook1/blob/main/docs/vol-II/vol-II-chap-5-sect-3.md)