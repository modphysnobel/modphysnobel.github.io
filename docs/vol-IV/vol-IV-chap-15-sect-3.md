...
* **Plasmonics and Hot-Carrier Dynamics:** In metallic nanostructures, collective electron oscillations known as <a href="https://en.wikipedia.org/wiki/Plasmon" title="here the definition">plasmons </a> decay into energetic "hot carriers" on attosecond timescales. Attosecond spectroscopy can directly reveal hot-carrier generation and plasmon dephasing processes that are critical for designing efficient devices for photocatalysis and energy harvesting.

* **Lightwave Electronics and Petahertz Switching:** Lightwave electronics uses the oscillating electric field of a laser pulse to drive and control electric currents in materials. Because the electric field of light oscillates at <a href="https://es.wiktionary.org/wiki/petahercio" title="here the definition">Petahertz</a> (10¹⁵ Hz) frequencies, millions of times faster than today's gigahertz technology, changing the limits of information processing.
