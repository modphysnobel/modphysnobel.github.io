...
![Fig 1](./figs/chap 14-3.PNG){width="250"}
...
In what follows, we describe the structure of a proposed reorganization of the Lecture according to the components of the contextualization of learning previously described. We do this in two levels: the first level corresponds to this section and the second level to Appendix 14.2. In this section we indicate each paragraph only in terms of the title explaining its content followed by its corresponding number. Afterwards, Appendix 14.2 consists in the complete description of the content of all the paragraphs by proposing a series of quotes taken from the original description of each paragraph.

!!! info "Contextualization of learning applied to Peebles´Nobel Lecture."
...
!!! info "14.1. Stars, pulsars and black holes."
...
!!! info "14.2. Neutrino oscillations, background radiations, accelerating expansion, and exoplanets."
...
### Appendix 14.2. Analysis of the content of Peebles´ Nobel Lecture *How Physical Cosmology Grew* according to contextualization of learning.

In Section 14.2 we described the application of contextualization of learning to Peebles´ Lecture, where the third component, the description of the answers to the generating questions, only contained the title explaining the meaning of each paragraph and its corresponding number. In this Appendix 14.2 we make explicit the content of those paragraphs by including a series of quotes taken from the original Lecture. In some cases, we add a NOTE for explanatory purposes.

Problematic situation: explain what Physical Cosmological is according to Peebles´ Nobel Lecture *How Physical Cosmology Grew.*
 
!!! info "GQ1: What characterizes the research life of James Peebles?"
...
!!! info "GQ2: What is the cosmic microwave background radiation?"
...
!!! info "GQ3: What is dark matter?"
	...
	**Ans3.2. The ΛCDM cosmology as a well-tested standard model.**
	...
	•	Measurements of CMB anisotropy confirmed characteristic of the ΛCDM model [Prg33].
